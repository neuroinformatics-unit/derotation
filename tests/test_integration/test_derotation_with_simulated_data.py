...
class SintheticData:
    ...
    def create_sample_image_with_two_cells(
        ...
        image = np.zeros((self.lines_per_frame, self.lines_per_frame), dtype=np.uint8)
    ...
    def plot_angles(self, incremental_angles: np.ndarray, sinusoidal_angles: np.ndarray):
        ...
        plt.savefig(f"debug/rotation_angles{self.center_of_rotation_offset}_{self.rotation_plane_angle}_{self.rotation_plane_orientation}.png")
    ...
    def plot_a_few_rotated_frames(
        ...
        plt.savefig(f"debug/rotated_stacks{self.center_of_rotation_offset}_{self.rotation_plane_angle}_{self.rotation_plane_orientation}.png")
    ...
    def plot_derotated_frames(self, derotated_sinusoidal: np.ndarray):
        ...
        plt.savefig(f"debug/derotated_sinusoidal{self.center_of_rotation_offset}_{self.rotation_plane_angle}_{self.rotation_plane_orientation}.png")
